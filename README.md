...
#### Santiago Fetecua Suárez - Edwar Lozano Florez
...
3.  Antes de que el servidor cierre la conexión por falta de comunicación:
    ...
    -- El codigo de error es 301 Moved Permanently, significa que esta y todas las solicitudes futuras deben dirigirse al URI dado.
    
    -   ¿Qué otros códigos de error existen?, ¿En qué caso se manejarán?
    **a. 1xx informational response:** Una respuesta informativa indica que la solicitud fue recibida y entendida.
    **b. 2xx success:** Esta clase de códigos de estado indica que la acción solicitada por el cliente fue recibida, comprendida y aceptada.
    **c. 3xx redirection:** Esta clase de código de estado indica que el cliente debe realizar una acción adicional para completar la solicitud. Muchos de estos códigos de estado se utilizan en la redirección de URL.
    **d. 4xx client errors:** Esta clase de código de estado está pensada para situaciones en las que el error parece haber sido causado por el cliente. 
    **e. 5xx server errors:** El servidor no pudo cumplir con una solicitud.
